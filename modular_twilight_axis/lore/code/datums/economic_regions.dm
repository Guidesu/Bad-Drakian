/datum/economic_region/kingsfield
	name = "Kingsfield"
	subtitle = "The Bastion of Azurian Sovereignty"
	description = "Kingsfield is a fortress city located on the coast south of the independent capital. The city is surrounded by massive walls and possesses a small battery of gunpowder artillery, imported from Grenzelhoft and capable of firing over the entire area of the Azure Basin, thereby protecting the realm from military invasion by sea. This is also the site of the realm's main seaport, where refugees, adventurers, and other foreigners regularly arrive. The main force of the sovereign guard is also housed here, ensuring the safety of the coastal road — essentially the only land route connecting the Azurian Valley with the rest of the world."
...
/datum/economic_region/rockhill
	...
	description = "A cluster of orchards and herb gardens to the north-west of Azuria, sheltered by a ridge that makes the climate there milder than it has any right to be. The many rolling hills of the county make for poor grain land but excellent orchard land. Genavan wine and liquor are renowned throughout Azuria, and some are exported beyond. It is a quiet, quaint, agricultural county, dotted with noble estates. Genavan apple brandy is the realm's most counterfeited drink. Every other inn from Bleakcoast to Kingsfield claims to serve it, but perhaps only a third of them actually do. The county is also known for its many country manor, with perhaps three quarter of the noble houses of the realm owning at least one in Genava."
...
/datum/economic_region/bleakcoast
	...
	description = "Also known as the Bleakisles Seamarch. A series of rocky outcrops to the north-east of the capital. The archipelago numbers in the dozens and makes navigation along all but a narrow stretch of Azuria's coast treacherous. What it lacks in fertile land it makes up for in the bounty of its seas. Schools of fish swarm in the shallow, rocky bottoms and swim as far as Azuria's coast, feeding thousands. But that bounty is not for Bleakisles inhabitants to enjoy. The isles are infested with pirates, the notorious Bleakisles Reavers, who prey on any merchant or fisherman that strays too far from shore. The realm maintains several garrisons to keep them in check, and has, once every two generations, undertaken a harrying of the isles, burning every non-military settlement and salting it. To no avail. Within a generation, the pirates always return, for trade is lucrative, and piracy even more so."

/datum/economic_region/northfort
	name = "Northfort"
	subtitle = "The Border Fort, Watch on the Northern Approach"
	description = "A fortified castle in the northern swamps of Azurian Valley. As economically unproductive as a fort can be, which is very. The crown feeds it because without it, the border between Grenzelhoft and Azuria becomes negotiable."

/datum/economic_region/heartfelt
	name = "Azure Enclave"
	subtitle = "Protector of the West, Shield Against the Darkness"
	description = "Located in the western regions of Azurian Valley, the castle of Azure Enclave serves as the primary bastion of law and order in these remote, scarcely populated lands. The castle's main function lies not as much in defending the western border, which does fairly effective job of protecting itself by being covered in impassible mountains and swamps - rather, Azure Enclave often acts as a shelter for populations of nearby villages during bandit raids, verevolf incursions and lycker attacks. Aside from defending the castle, the Enclave's garrison is also tasked with escorting trade and supply caravans that move between the region and the independent capital."
