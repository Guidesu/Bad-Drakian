/datum/erp_action/other/vagina/scissors
	...
	message_start = "{actor} presses {actor_their} vagina against {partner}'s pussy."
	message_tick = "{actor} {force} and {speed} rub {actor_their} vagina against {partner}'s vagina."
