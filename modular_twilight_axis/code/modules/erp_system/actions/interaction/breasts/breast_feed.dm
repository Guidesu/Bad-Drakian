/datum/erp_action/other/breasts/breast_feed
	...
	message_start  = "{actor} presses {partner}'s face to {actor_their} chest."
	message_tick   = "{actor} {force} and {speed} move {partner}'s head across {actor_their} chest."
	message_finish = "{actor} removes {partner}'s head from {actor_their} chest."
