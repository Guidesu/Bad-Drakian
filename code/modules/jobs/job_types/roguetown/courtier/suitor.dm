/datum/job/roguetown/suitor
	...
	tutorial = "You are a noble from a foreign house who has travelled to the realm to win favor with its court and secure a political ally for your house. Competition is fierce, and you are not the only one vying for the court's favor..."
