/datum/job/roguetown/hand
	...
	tutorial = "You owe everything to your liege. Once a humble friend, you are now one of the most important people in the realm. Years as spymaster and confidant to the ruling family have made you a living vault of secrets. Never let anyone forget whose ear receives your counsel; your whispers have killed more people than many swords."
	whitelist_req = TRUE
