/datum/job/roguetown/steward
	...
	tutorial = "Coin, coin, coin. You serve as the sovereign ruler's treasurer, guarding both wealth and information. You understand the hold that silver and gold have upon mortal souls—and how far people will go to acquire more. Keep the realm's economy alive; it may be the only thing you still trust."
