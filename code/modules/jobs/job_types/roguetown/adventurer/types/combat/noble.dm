/datum/advclass/noble
	name = "Aristocrat"
	tutorial = "You are a traveling noble visiting this sovereign realm. Inherited wealth attracts thieves as readily as it attracts courtiers, so tread carefully unless you wish to meet a grisly end."
