...
/client/proc/show_round_stats(featured_stat)
	...
	data += "<font color='#36959c'><span class='bold'>Points Awarded:</span></font> [GLOB.azure_round_stats[STATS_TRIUMPHS_AWARDED]]<br>"
	data += "<font color='#a02fa4'><span class='bold'>Points Stolen:</span></font> [GLOB.azure_round_stats[STATS_TRIUMPHS_STOLEN] * -1]<br>"
	...
	data += "<font color='#808080'><span class='bold'>Dwarves & Gnomes:</span></font> [GLOB.azure_round_stats[STATS_ALIVE_DWARVES] + GLOB.azure_round_stats[STATS_ALIVE_GNOMES]]<br>"
	...
	data += "<font color='#CD853F'><span class='bold'>Kobolds & Critterkin:</span></font> [GLOB.azure_round_stats[STATS_ALIVE_KOBOLDS] + GLOB.azure_round_stats[STATS_ALIVE_VERMINFOLK]]<br>"
	...
	data += "<font color='#c0c6c7'><span class='bold'>Constructs and Revenants:</span></font> [GLOB.azure_round_stats[STATS_ALIVE_CONSTRUCTS] + GLOB.azure_round_stats[STATS_ALIVE_REVENANTS]]<br>"
	...
	data += "<font color='#6d214f'><span class='bold'>Au Ra:</span></font> [GLOB.azure_round_stats[STATS_ALIVE_AURA]]<br>"
	data += "</div>"
