/datum/patron/divine/dendor
	...
	desc = "Dendor, God of the Wilds, was born from Abyssor's fevered dreams. He drove life from the oceans onto the land in an untamed surge, creating the natural world and every peril that followed with it."
...
/datum/patron/divine/dendor/can_pray(mob/living/follower)
	...
	for(var/obj/structure/flora/roguetree/wise in view(4, get_turf(follower)))
		return TRUE
	to_chat(follower, span_danger("For the Treefather to hear my prayer, I must stand in Dendor's wilds, within the Grove, near a wise tree, or beside a Pantheon Cross."))
	return FALSE
