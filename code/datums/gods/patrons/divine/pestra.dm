/datum/patron/divine/pestra
	...
	desc = "Pestra is the goddess of medicine, decay, and renewal. She blessed saints with healing hands and taught mortals to understand disease, tend wounds, and preserve life."
...
/datum/patron/divine/pestra/can_pray(mob/living/follower)
	...
	for(var/obj/structure/well/W in view(4, get_turf(follower)))
		return TRUE
	to_chat(follower, span_danger("For Pestra to hear my prayer, I must stand within the church or physician's house, near a psycross, or beside a well that reflects the cycle of life."))
	return FALSE
