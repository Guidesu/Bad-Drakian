...
/datum/map_adjustment
	...
	var/realm_name = "the realm"
	/// Formal realm type (e.g. "Sovereign County", "Most Serene Republic"). Changed by usurpation rites. (TA EDIT START)
	var/realm_type = "Sovereign County"
	/// Short form for casual references (e.g. "County", "Republic"). Changed by usurpation rites.)
	var/realm_type_short = "County" // TA EDIT END
