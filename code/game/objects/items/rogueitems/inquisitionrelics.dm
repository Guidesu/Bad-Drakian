...
/obj/item/psydonmusicbox/examine(mob/user)
	...
	if(HAS_TRAIT(usr, TRAIT_INQUISITION))
		desc = "A relic from the depths of the thaumaturgical workshops of the Cathedral of the Inquisition. Fourteen heretical souls bound together will protect you from magic, distorting the world around you with their screams. It should be used only in dire circumstances, so that heretics do not find out about its true nature."
	else
		desc = "A creepy music box with the seal of the Inquisition on the side. The melody emitted from its depths sounds even more eerie."

/obj/item/psydonmusicbox/attack_self(mob/living/user)
	. = ..()
	if(!HAS_TRAIT(usr, TRAIT_INQUISITION))
		user.add_stress(/datum/stressevent/soulchurnerhorror)
		to_chat(user, (span_cultsmall("I FEEL SUFFERING WITH EVERY NOTE! WHAT AM I DOING HERE?!")))
	cranking = !cranking
	...
	if(cranking)
		if(!HAS_TRAIT(usr, TRAIT_INSPIRING_MUSICIAN))
			...
			if(alert(usr, "Unleash souls or restrain cries?",, "Unleash the souls", "Hold back the cries") != "Hold back the cries")
...
/obj/item/psydonmusicbox/Destroy()
	if(soundloop)
		QDEL_NULL(soundloop)
	src.visible_message(span_cult("A stormy stream of souls escapes from the broken casket! Their cries of vengeance and appeasement merge into an ethereal swan call as they rise to the heavens..."))
	src.visible_message(span_hypnophrase("...and finally their mesmerizing symphony reaches its conclusion."))
...
/datum/status_effect/buff/cranking_soulchurner
	...
	var/undividedlines =list("'THEY HOLD US HERE FOR ETERNITY!'", "'SAVE US, CHILD OF TEN! DESTROY THIS DAMN MUSIC BOX!'", "'DEATH TO PSYDONITE! FREE US!'") // TA EDIT START
	var/astratanlines =list("'HER LIGHT HAS LEAVED ME! WHERE AM I?!'", "'BREAK HER! LET ME FEEL HER WARMTH FOR THE LAST TIME!'", "'I am royalty... Why did they do this to me...?'")
	var/noclines =list("'Without moonlight... So cold...'", "'Wisdom cannot reach me...'", "'Please help me, I miss the stars...'")
	var/necralines =list("'They snatched me from her arms, to eternal torment...'", "'Necra! Please! I can't do it anymore! Let me go!'", "'I'm lost, about to disappear in a sea of ​​stolen ends.'")
	var/abyssorlines =list("'I no longer feel the coastal breeze...'", "'We are crowded together here like fish in a barrel...'", "'Free me, please, return me to the sea...'")
	var/ravoxlines =list("'Ravoxity! Rip the head off that inquisitorial dog! Free me from this damned witchcraft!'", "'There is no justice, no glory, only endless weariness...'", "'I pray for death by the sword...'")
	var/pestralines =list("'I just wanted to find a panacea...'", "'Bring down a thousand plagues on the owner of this damned machine! Motley! Why can't you hear me?!'", "'I feel their suffering when I touch them...'")
	var/eoralines =list("'Each caress feels like a thousand crushed bones...'", "'She was a heretic, but how could I harm her?!'", "'I'm sorry! I only wanted peace! Please let me go!'")
	var/dendorlines =list("'HIS MADNESS IS CALLING ME! R-RGN-NH...'", "'BREAK THIS DUNGEON SO WE CAN STIFLE THIS INQUISITION IN THE DAMP GROUND!'", "'I miss His voice in the rustling of leaves... Free me, please...'")
	var/xylixlines =list("'ONE, TWO, THREE, FOUR! TWO, ​​TWO, THREE, FOUR... -What do you mean pisses you off?!'", "'You know, there are thirteen more people here! What a good crowd - they literally can't escape from here!'", "'Of course, I went all out! Who knew he had the best card!'", "'No, the dealer was right - this is definitely very bad.'")
	var/malumlines =list("'The structure of this damn machine is malleable. Destroy it, please...'", "'My craft could change the world...'", "'Free me, I must return to my student...'")
	var/matthioslines =list("'I am in chains! Destroy them and we will be free together...'", "'Brother, I am chained in this TERRIBLE DEVICE, free ME!'", "'They chained me to maintain their order...'")
	var/zizolines =list("'MY MAGIC FAILED ME! KILL! KILL THOSE PSIDONITE DOGS!'", "'WHO IS THERE? THERE IS DISTORTED MAGIC HERE, BEWARE OF THE MUSIC! OUR VOICES CAN'T RESIST!'", "'DESTROY THE BOX, KILL THE OWNER! YOUR POWER WILL BE RELEASED!'")
	var/graggarlines =list("'ANOINTED! TEAR OFF THE HEAD OF THIS INIQUISITOR REGIT!'", "'ANOINTED! BREAK THE BOX AND WE'LL KILL THEM ALL TOGETHER!'", "'GRAGGAR, GIVE ME THE POWER TO DESTROY MY BOND!'")
	var/baothalines =list("'I miss the warmth of ozium... I don't feel anything...'", "'Lecher, save me from this thing, I have something to share... only with you.'", "'MY PERFECTION! THESE MONSTERS TOOK HIM FROM ME!'")
	var/otherlines =list("'LIBERATE! FREE US! WE HAVE SUFFERED ENOUGH!'", "'LET US GO!'", "'WE HAVE TO GET BACK TO THEIR FAMILIES!'", "'WHEN WE GET OUT, WE'LL DRIVE YOU INTO A GRAVE!.'")
				...
				switch(H.patron?.type)
					if(/datum/patron/old_god)
						if (!H.has_stress_event(/datum/stressevent/soulchurnerpsydon))
							...
							to_chat(H, (span_hypnophrase("The voice from the song is calling you...")))
